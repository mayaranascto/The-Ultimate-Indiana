...
function scene:create( event )
	...
	local function onPass( e )
		if (e.phase == "began" and e.other.myName == "door" and score == 20 and haveKey == true) then
			ok = true
			print(ok)
  		end
    	return true
		...
		scene2Group:insert(image_star)
		scene2Group:insert(image_star2)
		scene2Group:insert(image_star3)
		scene2Group:insert(image_star4)
		scene2Group:insert(image_star5)
		scene2Group:insert(image_star6)
		scene2Group:insert(image_star7)
		scene2Group:insert(image_star8)
		scene2Group:insert(image_star9)
		scene2Group:insert(image_star10)
		scene2Group:insert(image_star11)
		scene2Group:insert(image_star_walls)
		scene2Group:insert(image_star_door)
		scene2Group:insert(image_star_key)
		scene2Group:insert(passDoor)
	    scene2Group:insert(indiana)
	    scene2Group:insert( back )
	    scene2Group:insert(buttons[1])
	    scene2Group:insert(buttons[2])
	    scene2Group:insert(buttons[3])
	    scene2Group:insert(buttons[4])
	    scene2Group:insert(coin1)
	    scene2Group:insert(coin2)
	    scene2Group:insert(coin3)
	    scene2Group:insert(coin4)
	    scene2Group:insert(coin5)
	    scene2Group:insert(coin6)
	    scene2Group:insert(coin7)
	    scene2Group:insert(coin8)
	    scene2Group:insert(coin9)
	    scene2Group:insert(coin10)
	    scene2Group:insert( scoreLabel )
	    scene2Group:insert( vidasLabel )
	    scene2Group:insert( moedas )
	    scene2Group:insert( vidas )
	    scene2Group:insert( control )
	    scene2Group:insert( control )
	    scene2Group:insert( coracao )
	    --scene2Group:insert( timeLabel )
