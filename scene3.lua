...
function scene:create( event )
	...
	image_star_key.x = 235
	image_star_key.y = 285
	...
	image_star4.x = 40
	image_star4.y = 245
	image_star4.myName="obstaculo20"
	...
	image_star7.x = 420
	image_star7.y = 65
	image_star7.myName="obstaculo21"
	...
	local function onPass( e )
		if (e.phase == "began" and e.other.myName == "door" and score == 30 and haveKey == true) then
			ok = true
		...
		scene3Group:insert(image_star)
		scene3Group:insert(image_star2)
		scene3Group:insert(image_star3)
		scene3Group:insert(image_star4)
		scene3Group:insert(image_star5)
		scene3Group:insert(image_star6)
		scene3Group:insert(image_star7)
		scene3Group:insert(image_star8)
		scene3Group:insert(image_star9)
		scene3Group:insert(image_star10)
		scene3Group:insert(image_star11)
		scene3Group:insert(image_star_walls)
		scene3Group:insert(image_star_door)
		scene3Group:insert(image_star_key)
		scene3Group:insert(passDoor)
	    scene3Group:insert(indiana)
	    scene3Group:insert( back )
	    scene3Group:insert(buttons[1])
	    scene3Group:insert(buttons[2])
	    scene3Group:insert(buttons[3])
	    scene3Group:insert(buttons[4])
	    scene3Group:insert(coin1)
	    scene3Group:insert(coin2)
	    scene3Group:insert(coin3)
	    scene3Group:insert(coin4)
	    scene3Group:insert(coin5)
	    scene3Group:insert(coin6)
	    scene3Group:insert(coin7)
	    scene3Group:insert(coin8)
	    scene3Group:insert(coin9)
	    scene3Group:insert(coin10)
	    scene3Group:insert( scoreLabel )
	    scene3Group:insert( vidasLabel )
	    scene3Group:insert( moedas )
	    scene3Group:insert( vidas )
	    scene3Group:insert( control )
	    scene3Group:insert( coracao )
