...
function scene:create( event )
	...
	local soundBack = audio.loadStream( "retrosoul.mp3" )
	...
	image_star_key.x = 430
	image_star_key.y = 160

	physics.addBody( image_star_key,"static", { outline=image_outline_key})



	local image_door = "door3.png"	
	...
	image_star_door.y = 33
	image_star_door.myName="obstaculov"

	physics.addBody( image_star_door,"static", { outline=image_outline_door})



	local image_walls = "walls2.png"
	...
	image_star8.x = 50
	image_star8.y = 90
	image_star8.myName="obstaculov"


	physics.addBody( image_star8,"static", { outline=image_outline8})


	local image_name9 = "ob30_1.png"
	...
	image_star9.x = 330
	image_star9.y = 90
	image_star9.myName="obstaculov"


	physics.addBody( image_star9,"static", { outline=image_outline9})


	local image_name10 = "ob30_1.png"
	...
	image_star10.x = 430
	image_star10.y = 90
	image_star10.myName="obstaculov"


	physics.addBody( image_star10,"static", { outline=image_outline10})


	local image_name11 = "ob30_1.png"

	local image_outline11 = graphics.newOutline(2, image_name11 )

	local image_star11 = display.newImage( image_name11)
	image_star11.x = 100
	image_star11.y = 40
	image_star11.myName="obstaculov"


	physics.addBody( image_star11,"static", { outline=image_outline11})


	local image_name12 = "ob30_1.png"

	local image_outline12 = graphics.newOutline(2, image_name12 )

	local image_star12 = display.newImage( image_name12)
	image_star12.x = 380
	image_star12.y = 280
	image_star12.myName="obstaculov"


	physics.addBody( image_star12,"static", { outline=image_outline12})


	local image_name13 = "ob30_1.png"

	local image_outline13 = graphics.newOutline(2, image_name13 )

	local image_star13 = display.newImage( image_name13)
	image_star13.x = 380
	image_star13.y = 40
	image_star13.myName="obstaculov"


	physics.addBody( image_star13,"static", { outline=image_outline13})



	local image_name14 = "ob30_1.png"

	local image_outline14 = graphics.newOutline(2, image_name14 )

	local image_star14 = display.newImage( image_name14)
	image_star14.x = 100
	image_star14.y = 280
	image_star14.myName="obstaculov"


	physics.addBody( image_star14,"static", { outline=image_outline14})


	local image_name15 = "ob30_1.png"

	local image_outline15 = graphics.newOutline(2, image_name15 )

	local image_star15 = display.newImage( image_name15)
	image_star15.x = 380
	image_star15.y = 145
	image_star15.myName="obstaculov"


	physics.addBody( image_star15,"static", { outline=image_outline15})


	local image_name16 = "ob30_1.png"

	local image_outline16 = graphics.newOutline(2, image_name16 )

	local image_star16 = display.newImage( image_name16)
	image_star16.x = 100
	image_star16.y = 180
	image_star16.myName="obstaculov"


	physics.addBody( image_star16,"static", { outline=image_outline16})
	...
	local passDoor = display.newLine( -30, 30, -30, 40 )
	passDoor.myName = "door"

	wallUp.isVisible = false
	wallUp.myName="obstaculov"
	wallDown.isVisible = false
	wallDown.myName="obstaculov"
	wallRight.isVisible = false
	wallRight.myName="obstaculov"
	wallLeft.isVisible = false
	wallLeft.myName="obstaculov"
	...
	local function onCollisionCoin (e)
	...
	local function onCollisionObs (e)
		if (e.phase == "began" and (e.other.myName == "obstaculov")) then
			obs = true
			print(obs)
			print(vida)
			print (obs)
	...
	local function onPass( e )
		if (e.phase == "began" and e.other.myName == "door" and score == 40 and haveKey == true) then
			ok = true
		...
		scene4Group:insert( background )
		scene4Group:insert(image_star)
		scene4Group:insert(image_star2)
		scene4Group:insert(image_star3)
		scene4Group:insert(image_star4)
		scene4Group:insert(image_star5)
		scene4Group:insert(image_star6)
		scene4Group:insert(image_star7)
		scene4Group:insert(image_star8)
		scene4Group:insert(image_star9)
		scene4Group:insert(image_star10)
		scene4Group:insert(image_star11)
		scene4Group:insert(image_star12)
		scene4Group:insert(image_star13)
		scene4Group:insert(image_star14)
		scene4Group:insert(image_star15)
		scene4Group:insert(image_star16)
		scene4Group:insert(image_star_walls)
		scene4Group:insert(image_star_door)
		scene4Group:insert(image_star_key)
		scene4Group:insert(passDoor)
	    scene4Group:insert(indiana)
	    scene4Group:insert( back )
	    scene4Group:insert(buttons[1])
	    scene4Group:insert(buttons[2])
	    scene4Group:insert(buttons[3])
	    scene4Group:insert(buttons[4])
	    scene4Group:insert(coin1)
	    scene4Group:insert(coin2)
	    scene4Group:insert(coin3)
	    scene4Group:insert(coin4)
	    scene4Group:insert(coin5)
	    scene4Group:insert(coin6)
	    scene4Group:insert(coin7)
	    scene4Group:insert(coin8)
	    scene4Group:insert(coin9)
	    scene4Group:insert(coin10)
	    scene4Group:insert( scoreLabel )
	    scene4Group:insert( vidasLabel )
	    scene4Group:insert( moedas )
	    scene4Group:insert( vidas )
	    scene4Group:insert( control )
	    scene4Group:insert( coracao )
